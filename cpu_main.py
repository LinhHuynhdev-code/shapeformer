...
# -------------------------------------------- Input and Output --------------------------------------------------------
parser.add_argument('--data_path', default='/kaggle/input/uea-dataset/Multivariate_ts', choices={'/kaggle/input/uea-dataset/Multivariate_ts', '/kaggle/input/uea-dataset/Multivariate_ts'},
                    help='Data path')
parser.add_argument('--output_dir', default='/kaggle/working/shapeformer/Results',
